...
(() => {
  ...
  function convertModuleLinks(html) {
    const version = sessionStorage.getItem('em9-version');

    html = html
      .replace(/@em9-style\/em9/g, `https://cdn.skypack.dev/@webcomponents/em9webcomponents@${version}`)
            ...
            <div class="code-block ${isExpanded ? 'code-block--expanded' : ''}">
              <div class="code-block__preview">
                ...
                <div class="code-block__resizer">
                  <em9-icon name="twotone-arrow-swap-horizontal"></em9-icon>
                </div>
              </div>
  ...
  document.addEventListener('click', event => {
    ...
    if (button?.classList.contains('code-block__button--codepen')) {
      ...
      if (!isReact) {
        htmlTemplate =
          `<script type="module" src="https://webcomponents-qa.mycardplace.com/dist/em9Library.js"></script>\n` +
          `\n${htmlExample}`;
        jsTemplate = '';
      }
      ...
      if (isReact) {
        ...
        jsTemplate =
          ...
          `import { setBasePath } from 'https://cdn.skypack.dev/@webcomponents/em9webcomponents@${version}/dist/utilities/base-path';\n` +
          `\n` +
          `// Set the base path for em9-Library assets\n` +
          `setBasePath('https://cdn.skypack.dev/@webcomponents/em9webcomponents@${version}/dist/')\n` +
      ...
      // CSS templates
      cssTemplate =
        `@import 'https://cdn.jsdelivr.net/npm/@webcomponents/em9webcomponents@${version}/dist/themes/${
          isDark ? 'dark' : 'light'
        }.css';\n` +
        '\n' +
        'body {\n' +
        ...
        '  color: var(--em9-color-neutral-900);\n' +
        '  padding: 1rem;\n' +
        '}';
      ...
      const data = {
        title: '',
        description: '',
        tags: ['em9', 'web components'],
        editors,
        head: `<meta name="viewport" content="width=device-width">`,
        html_classes: `em9-theme-${isDark ? 'dark' : 'light'}`,
        css_external: ``,
        js_external: ``,
        js_module: true,
