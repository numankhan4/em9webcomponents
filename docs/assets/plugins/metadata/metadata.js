(() => {
  ...
  const isNext = location.hostname === 'next.em9.style';
        ...
        ${props
          .map(prop => {
            ...
            if (!hasAttribute) {
              ...
              attributeInfo = `
                <br>
                <em9-tooltip content="This attribute is different from its property">
                  <small>
                    <code class="nowrap">
            ...
            return `
              <tr>
                ...
                <td style="text-align: center;">${
                  prop.reflects ? '<em9-icon label="yes" name="check"></em9-icon>' : ''
                }</td>
  ...
  window.$docsify.plugins.push(hook => {
    hook.mounted(async () => {
      ...
      sessionStorage.setItem('em9-version', metadata.package.version);

      // Add repo buttons
      const buttons = document.createElement('div');
      buttons.classList.add('sidebar-buttons');
      // buttons.innerHTML = `
      //   <em9-button size="small" class="repo-button repo-button--sponsor" href="https://github.com/sponsors/claviska" target="_blank">
      //     <em9-icon slot="prefix" name="heart"></em9-icon> Sponsor
      //   </em9-button>
      //   <em9-button size="small" class="repo-button repo-button--github" href="https://github.com/em9-style/em9/stargazers" target="_blank">
      //     <em9-icon slot="prefix" name="github"></em9-icon> <span class="github-star-count">Star</span>
      //   </em9-button>
      //   <em9-button size="small" class="repo-button repo-button--twitter" href="https://twitter.com/em9_style" target="_blank">
      //     <em9-icon slot="prefix" name="twitter"></em9-icon> Follow
      //   </em9-button>
      // `;
    ...
    hook.beforeEach(async (content, next) => {
      ...
      content = content.replace(/\[component-header:([a-z0-9-]+)\]/g, (match, tag) => {
        ...
        result += `
          <div class="component-header">
            ...
            <div class="component-header__info">
              <em9-badge variant="neutral" pill>
                Since ${component.since || '?'}
              </em9-badge>

              <em9-badge variant="${badgeType}" pill style="text-transform: capitalize;">
                ${component.status}
              </em9-badge>
            </div>
          </div>
      ...
      content = content.replace(/\[component-metadata:([a-z0-9-]+)\]/g, (match, tag) => {
        const component = getComponent(metadata, tag);
        let result = '';
        ...
        if (component.path) {
          ...
          result += `
            ...
            <em9-tab-group>
            <em9-tab slot="nav" panel="script">Script</em9-tab>
            <em9-tab slot="nav" panel="import">Import</em9-tab>
            <em9-tab slot="nav" panel="bundler">Bundler</em9-tab>
            <em9-tab slot="nav" panel="react">React</em9-tab>

            <em9-tab-panel name="script">\n
            To import this component from [the CDN](https://www.jsdelivr.com/package/npm/@webcomponents/em9webcomponents) using a script tag:

            \`\`\`html
            <script type="module" src="https://cdn.jsdelivr.net/npm/@webcomponents/em9webcomponents@${metadata.package.version}/${component.path}"></script>
            \`\`\`
            </em9-tab-panel>

            <em9-tab-panel name="import">\n
            To import this component from [the CDN](https://www.jsdelivr.com/package/npm/@webcomponents/em9webcomponents) using a JavaScript import:

            \`\`\`js
            import 'https://cdn.jsdelivr.net/npm/@webcomponents/em9webcomponents@${metadata.package.version}/${component.path}';
            \`\`\`
            </em9-tab-panel>

            <em9-tab-panel name="bundler">\n
            To import this component using [a bundler](/getting-started/installation#bundling):
            \`\`\`js
            import '@webcomponents/em9webcomponents/${component.path}';
            \`\`\`
            </em9-tab-panel>

            <em9-tab-panel name="react">\n
            To import this component as a [React component](/frameworks/react):
            \`\`\`js
            import { ${component.name} } from '@webcomponents/em9webcomponents/dist/react';
            \`\`\`
            </em9-tab-panel>
            </em9-tab-group>
          `;
    ...
    hook.doneEach(() => {
      if (document.getElementById('data-table')) {
        document.querySelector('.markdown-section').classList.add('data-table-wrapper');
      } else {
        document.querySelector('.markdown-section').classList.remove('data-table-wrapper');
      }
