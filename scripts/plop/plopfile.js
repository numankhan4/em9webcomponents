export default function (plop) {
  plop.setHelper('tagWithoutPrefix', tag => tag.replace(/^em9-/, ''));
    ...
    prompts: [
      {
        type: 'input',
        name: 'tag',
        message: 'Tag name? (e.g. em9-button)',
        validate: value => {
          // Start with em9- and include only a-z + dashes
          if (!/^em9-[a-z-+]+/.test(value)) {
            return false;
          }
