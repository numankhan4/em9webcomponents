...
import type em9ProgressBar from './progress-bar';

describe('<em9-progress-bar>', () => {
  let el: em9ProgressBar;

  describe('when provided just a value parameter', () => {
    before(async () => {
      el = await fixture<em9ProgressBar>(html`<em9-progress-bar value="25"></em9-progress-bar>`);
    });
  ...
  describe('when provided a title, and value parameter', () => {
    ...
    before(async () => {
      el = await fixture<em9ProgressBar>(
        html`<em9-progress-bar title="Titled Progress Ring" value="25"></em9-progress-bar>`
      );
  ...
  describe('when provided an indeterminate parameter', () => {
    ...
    before(async () => {
      el = await fixture<em9ProgressBar>(
        html`<em9-progress-bar title="Titled Progress Ring" indeterminate></em9-progress-bar>`
      );
      base = el.shadowRoot!.querySelector('[part="base"]')!;
    });
  ...
  describe('when provided a ariaLabel, and value parameter', () => {
    before(async () => {
      el = await fixture<em9ProgressBar>(
        html`<em9-progress-bar ariaLabel="Labelled Progress Ring" value="25"></em9-progress-bar>`
      );
    });
    ...
    before(async () => {
      el = await fixture<em9ProgressBar>(
        html`
          ...
          <em9-progress-bar ariaLabelledBy="labelledby" value="25"></em9-progress-bar>
        `
      );
    });
