 ...
 * @dependency em9-icon
 *
 * @event em9-load - Emitted when the image loads successfully.
 * @event em9-error - Emitted when the image fails to load.
 *
 ...
 */
@customElement('em9-animated-image')
export default class em9AnimatedImage extends LitElement {
        ...
        ${this.isLoaded
          ? html`
              ...
              <div part="control-box" class="animated-image__control-box">
                ${this.play
                  ? html`<em9-icon part="pause-icon" name="pause-fill" library="system"></em9-icon>`
                  : html`<em9-icon part="play-icon" name="play-fill" library="system"></em9-icon>`}
              </div>
            `
          : ''}
      </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'em9-animated-image': em9AnimatedImage;
  }
}
