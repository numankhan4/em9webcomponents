...
import type em9Input from '../../components/input/input';
 ...
 * @status stable
 *
 * @dependency em9-button
 * @dependency em9-button-group
 * @dependency em9-dropdown
 * @dependency em9-input
 * @dependency em9-visually-hidden
 *
 * @slot label - The color picker's label. Alternatively, you can use the label prop.
 *
 * @event em9-change Emitted when the color picker's value changes.
 *
 ...
 */
@customElement('em9-color-picker')
export default class em9ColorPicker extends LitElement {
  static styles = styles;

  @query('[part="input"]') input: em9Input;
  @query('[part="preview"]') previewButton: HTMLButtonElement;
  @query('.color-dropdown') dropdown: em9Dropdown;
  ...
  render() {
      ...
      >
        ...
        <div class="color-picker__user-input" aria-live="polite">
          <em9-input
            ...
            @em9-change=${this.handleInputChange}
          ></em9-input>
    ...
    return html`
      <em9-dropdown
        ...
        ?disabled=${this.disabled}
        ?hoist=${this.hoist}
        @em9-after-hide=${this.handleAfterHide}
      >
        <button
          part="trigger"
          slot="trigger"
...
declare global {
  interface HTMLElementTagNameMap {
    'em9-color-picker': em9ColorPicker;
  }
}
