...
import type em9BreadcrumbItem from '../../components/breadcrumb-item/breadcrumb-item';
 ...
 */
@customElement('em9-breadcrumb')
export default class em9Breadcrumb extends LitElement {
  ...
  handleSlotChange() {
    const items = [...this.defaultSlot.assignedElements({ flatten: true })].filter(
      item => item.tagName.toLowerCase() === 'em9-breadcrumb-item'
    ) as em9BreadcrumbItem[];
  ...
  render() {
    ...
    return html`
      ...
      <slot name="separator" hidden aria-hidden="true">
        <em9-icon name=${this.localize.dir() === 'rtl' ? 'chevron-left' : 'chevron-right'} library="system"></em9-icon>
      </slot>
    `;
  }
}
