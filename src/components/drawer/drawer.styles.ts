...
export default css`
  ...
  :host {
    --size: 25rem;
    --header-spacing: var(--em9-spacing-large);
    --body-spacing: var(--em9-spacing-large);
    --footer-spacing: var(--em9-spacing-large);
  ...
  .drawer--fixed {
    position: fixed;
    z-index: var(--em9-z-index-drawer);
  }
  ...
  .drawer__panel {
    ...
    transition: var(--em9-transition-medium) transform;
    overflow: auto;
    pointer-events: all;
  }
  ...
  .drawer__footer ::slotted(em9-button:not(:last-of-type)) {
