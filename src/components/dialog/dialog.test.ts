...
import type em9Dialog from './dialog';

describe('<em9-dialog>', () => {
  it('should be visible with the open attribute', async () => {
    const el = await fixture<em9Dialog>(html`
      <em9-dialog open>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</em9-dialog>
    `);
  ...
  it('should not be visible without the open attribute', async () => {
    const el = await fixture<em9Dialog>(
      html` <em9-dialog>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</em9-dialog> `
    );
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part="base"]')!;
  ...
  it('should emit em9-show and em9-after-show when calling show()', async () => {
    const el = await fixture<em9Dialog>(html`
      <em9-dialog>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</em9-dialog>
    `);
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part="base"]')!;
  ...
  it('should allow initial focus to be set', async () => {
    const el = await fixture<em9Dialog>(html` <em9-dialog><input /></em9-dialog> `);
