 ...
 * @status experimental
 *
 * @event em9-reposition - Emitted when the divider's position changes.
 *
 ...
 */
@customElement('em9-split-panel')
export default class em9SplitPanel extends LitElement {
