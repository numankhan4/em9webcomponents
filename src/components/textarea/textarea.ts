 ...
 */
@customElement('em9-textarea')
export default class em9Textarea extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      >
        ...
        >
          <slot name="label">
            ${this.label}${this.required ?html`<em9-icon part="required" name="cs-bold-indicator"></em9-icon>` : ''}
          </slot>
        </label>
