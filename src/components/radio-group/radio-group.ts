...
import type em9Radio from '../../components/radio/radio';

const RADIO_CHILDREN = ['em9-radio', 'em9-radio-button'];
 ...
 */
@customElement('em9-radio-group')
export default class em9RadioGroup extends LitElement {
  ...
  handleSlotChange() {
    ...
    this.hasButtonGroup = !!radios.find(radio => radio.tagName.toLowerCase() === 'em9-radio-button');
  ...
  render() {
    ...
    return html`
      ...
      >
        ...
        ${this.hasButtonGroup
          ? html`<em9-button-group part="button-group">${defaultSlot}</em9-button-group>`
          : defaultSlot}
      </fieldset>
    `;
  }
