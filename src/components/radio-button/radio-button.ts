 ...
 * @event em9-change - Emitted when the button's checked state changes.
 ...
 */
@customElement('em9-radio-button')
export default class em9RadioButton extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'em9-radio-button': em9RadioButton;
  }
}
