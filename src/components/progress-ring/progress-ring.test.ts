...
import type em9ProgressRing from './progress-ring';

describe('<em9-progress-ring>', () => {
  let el: em9ProgressRing;

  describe('when provided just a value parameter', () => {
    before(async () => {
      el = await fixture<em9ProgressRing>(html`<em9-progress-ring value="25"></em9-progress-ring>`);
    });
  ...
  describe('when provided a title, and value parameter', () => {
    ...
    before(async () => {
      el = await fixture<em9ProgressRing>(
        html`<em9-progress-ring title="Titled Progress Ring" value="25"></em9-progress-ring>`
      );
  ...
  describe('when provided a ariaLabel, and value parameter', () => {
    before(async () => {
      el = await fixture<em9ProgressRing>(
        html`<em9-progress-ring ariaLabel="Labelled Progress Ring" value="25"></em9-progress-ring>`
      );
    });
    ...
    before(async () => {
      el = await fixture<em9ProgressRing>(
        html`
          ...
          <em9-progress-ring ariaLabelledBy="labelledby" value="25"></em9-progress-ring>
        `
      );
    });
