...
import type em9BreadcrumbItem from './breadcrumb-item';

describe('<em9-breadcrumb-item>', () => {
  let el: em9BreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<em9BreadcrumbItem>(html` <em9-breadcrumb-item>Home</em9-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<em9BreadcrumbItem>(html`
          <em9-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</em9-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<em9BreadcrumbItem>(html`
          <em9-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</em9-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<em9BreadcrumbItem>(html`
          <em9-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</em9-breadcrumb-item
          >
        `);
      });
