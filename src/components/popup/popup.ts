 ...
 * @status stable
 *
 * @event em9-reposition - Emitted when the popup is repositioned. This event can fire a lot, so avoid putting expensive
 ...
 *  attribute is used.
 * @cssproperty [--arrow-color=var(--em9-color-neutral-0)] - The color of the arrow.
 ...
 *  available when using `auto-size`.
 */
@customElement('em9-popup')
export default class em9Popup extends em9IncElement {
