 ...
 * @status stable
 *
 * @event em9-mutation - Emitted when a mutation occurs.
 *
 * @slot - The content to watch for mutations.
 */
@customElement('em9-mutation-observer')
export default class em9MutationObserver extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'em9-mutation-observer': em9MutationObserver;
  }
}
