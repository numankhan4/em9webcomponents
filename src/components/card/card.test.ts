...
describe('<em9-card>', () => {
  ...
  describe('when provided no parameters', () => {
    before(async () => {
      el = await fixture<em9Card>(
        html` <em9-card>This is just a basic card. No image, no header, and no footer. Just your content.</em9-card> `
      );
    });
