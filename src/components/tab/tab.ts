 ...
 *
 * @event em9-close - Emitted when the tab is closable and the close button is activated.
 *
 * @csspart base - The component's internal wrapper.
 * @csspart close-button - The close button.
 * @csspart close-button__base - The close button's `base` part.
 */
@customElement('em9-tab')
export default class em9Tab extends LitElement {
  ...
  private readonly componentId = `em9-tab-${this.attrId}`;
