...
import type em9Tab from './tab';

describe('<em9-tab>', () => {
  it('should render default tab', async () => {
    const el = await fixture<em9Tab>(html` <em9-tab>Test</em9-tab> `);
  ...
  it('should disable tab by attribute', async () => {
    const el = await fixture<em9Tab>(html` <em9-tab disabled>Test</em9-tab> `);
  ...
  it('should set active tab by attribute', async () => {
    const el = await fixture<em9Tab>(html` <em9-tab active>Test</em9-tab> `);
  ...
  it('should set closable by attribute', async () => {
    const el = await fixture<em9Tab>(html` <em9-tab closable>Test</em9-tab> `);
  ...
  describe('closable', () => {
    it('should emit close event when close button clicked', async () => {
      ...
      el.addEventListener('em9-close', spy, { once: true });
