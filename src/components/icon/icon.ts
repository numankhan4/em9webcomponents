 ...
 * @status stable
 *
 * @event em9-load - Emitted when the icon has loaded.
 * @event em9-error - Emitted when the icon fails to load due to an error.
 *
 * @csspart base - The component's internal wrapper.
 */
@customElement('em9-icon')
export default class em9Icon extends LitElement {
