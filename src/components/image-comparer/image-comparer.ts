 ...
 *
 * @event em9-change - Emitted when the position changes.
 *
 ...
 */
@customElement('em9-image-comparer')
export default class em9ImageComparer extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'em9-image-comparer': em9ImageComparer;
  }
}
