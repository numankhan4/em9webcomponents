 ...
 * @dependency em9-icon
 *
 * @event em9-change - Emitted when the rating's value changes.
 *
 ...
 */
@customElement('em9-rating')
export default class em9Rating extends LitElement {
  ...
  @property() getSymbol: (value: number) => string = () => '<em9-icon name="star-fill" library="system"></em9-icon>';
