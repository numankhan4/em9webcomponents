 ...
 * @status stable
 *
 * @event em9-cancel - Emitted when the animation is canceled.
 * @event em9-finish - Emitted when the animation finishes.
 * @event em9-start - Emitted when the animation starts or restarts.
 *
 ...
 */
@customElement('em9-animation')
export default class em9Animation extends LitElement {
  ...
  /**
   * The easing function to use for the animation. This can be a em9-Library easing function or a custom easing function
  ...
  handleAnimationFinish() {
    ...
    emit(this, 'em9-finish');
  }

  handleAnimationCancel() {
    this.play = false;
    this.hasStarted = false;
    emit(this, 'em9-cancel');
  }
