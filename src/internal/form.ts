...
export class FormSubmitController implements ReactiveController {
  ...
  hostConnected() {
    ...
    if (this.form) {
      ...
      // Overload the form's reportValidity() method so it looks at em9-Library form controls
  ...
  reportFormValidity() {
    //
    // em9-Library form controls work hard to act like regular form controls. They support the Constraint Validation API
    ...
    if (this.form && !this.form.noValidate) {
      // This seems sloppy, but checking all elements will cover native inputs, em9-Library inputs, and other custom
